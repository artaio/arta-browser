...
export const ShipmentException = ({
  ...
  const exception = shipment.shipment_exceptions.find(
    (exception) =>
      exception.status === 'new' || exception.status === 'in_progress'
  );
  ...
  return (
    <div class="artajs__tracking__exception__wrapper">
      ...
      <div class="artajs__tracking__exception__content">
        ...
        <div class="artajs__tracking__exception__title">{exception.type}</div>
        <a
